...
class CommentariesControllerTest < ActionController::TestCase
  ...
  test "should create commentary" do
    assert_difference('Commentary.count') do
      post :create, commentary: { item_id: @commentary.item_id, message: @commentary.message, user_id: @commentary.user_id }
    end
  ...
  test "should update commentary" do
    patch :update, id: @commentary, commentary: { item_id: @commentary.item_id, message: @commentary.message, user_id: @commentary.user_id }
    assert_redirected_to commentary_path(assigns(:commentary))
  end
